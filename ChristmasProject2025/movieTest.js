let movieQuestions = [
    ...
    "Which movie has the IMDB score of "
];

let movieQuestionsPart2 = [
    1992, 1993, 1996, 1997, 2000, 5.1, 5.2, 5.6, 5.7, 6.0
];

let george = [1997, 5.6];
let harriet = [1996, 6.0];
let beverly = [1993, 5.1];
let beethoven = [1992, 5.7];
let lips = [2000, 5.2];
